...
export function produceHighlighted(text, el) {
    ...
    let groups = new Map();
    let selectedGroup;
    function addToGroup(name, element) {
        let group;
        if (groups.has(name)) {
    ...
    function pushSpan(text, colorClass) {
    ...
    function pushSpelling(colorClass) {
        let span = document.createElement("span");
