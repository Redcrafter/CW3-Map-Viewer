...
export function generateMesh(map) {
        ...
        for (let x = 0; x < width; x++) {
            ...
            if (l > h && l == r && l == t && l == b) {
                ...
                if (l != 500) {
                    ...
                    uvs.push(...lUv.tl, lUv.x + lUv.w / 2, 1 - lUv.y, lUv.x, 1 - (lUv.y + lUv.h / 2), lUv.x + lUv.w / 2, 1 - lUv.y, ...lUv.tr, lUv.x + lUv.w, 1 - (lUv.y + lUv.h / 2), lUv.x + lUv.w, 1 - (lUv.y + lUv.h / 2), ...lUv.br, lUv.x + lUv.w / 2, 1 - (lUv.y + lUv.h), lUv.x + lUv.w / 2, 1 - (lUv.y + lUv.h), ...lUv.bl, lUv.x, 1 - (lUv.y + lUv.h / 2));
                ...
                uvs.push(mainUv.x, 1 - (mainUv.y + mainUv.h / 2), mainUv.x + mainUv.w / 2, 1 - mainUv.y, mainUv.x + mainUv.w / 2, 1 - (mainUv.y + mainUv.h), mainUv.x + mainUv.w / 2, 1 - mainUv.y, mainUv.x + mainUv.w, 1 - (mainUv.y + mainUv.h / 2), mainUv.x + mainUv.w / 2, 1 - (mainUv.y + mainUv.h));
            ...
            if (l > h && l == r && l == t) {
                ...
                if (l != 500) {
                    ...
                    uvs.push(...lUv.tl, lUv.x + lUv.w / 2, 1 - lUv.y, ...lUv.bl, lUv.x + lUv.w / 2, 1 - lUv.y, ...lUv.tr, ...lUv.br);
                    colors.push(b, b, b, 1, b, b, b, 1, b, b, b, 1, b, b, b, 1, b, b, b, 1, b, b, b, 1);
                }
                vertices.push(x, y + 1, x + 0.5, y, x + 1, y + 1);
                uvs.push(...mainUv.bl, mainUv.x + mainUv.w / 2, 1 - mainUv.y, ...mainUv.br);
            ...
            if (l > h && l == b && l == t) {
                ...
                if (l != 500) {
                    ...
                    uvs.push(...lUv.tl, ...lUv.tr, lUv.x, 1 - (lUv.y + lUv.h / 2), lUv.x, 1 - (lUv.y + lUv.h / 2), ...lUv.br, ...lUv.bl);
                    colors.push(b, b, b, 1, b, b, b, 1, b, b, b, 1, b, b, b, 1, b, b, b, 1, b, b, b, 1);
                }
                vertices.push(x + 1, y, x + 1, y + 1, x, y + 0.5);
                uvs.push(...mainUv.tr, ...mainUv.br, mainUv.x, 1 - (mainUv.y + mainUv.h / 2));
                colors.push(brightness, brightness, brightness, 1, brightness, brightness, brightness, 1, brightness, brightness, brightness, 1);
                continue;
            }
            if (l > h && l == b && l == r) {
                ...
                if (l != 500) {
                    ...
                    uvs.push(...lUv.tl, lUv.x + lUv.w / 2, 1 - (lUv.y + lUv.h), ...lUv.bl, lUv.x + lUv.w / 2, 1 - (lUv.y + lUv.h), ...lUv.tr, ...lUv.br);
                    colors.push(b, b, b, 1, b, b, b, 1, b, b, b, 1, b, b, b, 1, b, b, b, 1, b, b, b, 1);
                }
                vertices.push(x, y, x + 1, y, x + 0.5, y + 1);
                uvs.push(...mainUv.tl, ...mainUv.tr, mainUv.x + mainUv.w / 2, 1 - (mainUv.y + mainUv.h));
                colors.push(brightness, brightness, brightness, 1, brightness, brightness, brightness, 1, brightness, brightness, brightness, 1);
                continue;
            }
            if (r > h && r == b && r == t) {
                ...
                if (r != 500) {
                    ...
                    uvs.push(...rUv.tl, ...rUv.tr, rUv.x + rUv.w, 1 - (rUv.y + rUv.h / 2), rUv.x + rUv.w, 1 - (rUv.y + rUv.h / 2), ...rUv.br, ...rUv.bl);
                    colors.push(b, b, b, 1, b, b, b, 1, b, b, b, 1, b, b, b, 1, b, b, b, 1, b, b, b, 1);
                }
                vertices.push(x, y, x + 1, y + 0.5, x, y + 1);
                uvs.push(...mainUv.tl, mainUv.x + mainUv.w, 1 - (mainUv.y + mainUv.h / 2), ...mainUv.bl);
                colors.push(brightness, brightness, brightness, 1, brightness, brightness, brightness, 1, brightness, brightness, brightness, 1);
                continue;
            }
            if (l > h && l == t) {
